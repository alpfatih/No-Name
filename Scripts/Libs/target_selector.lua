--[[
   Library: Target Selector Library v0.3a
    Author: Modified by Keoshin/Taikumi
   Credits: This script was largely (99.9%) based on FPB's Target Selector Library by H0nda/Weee.
 ...
 Changelog:
       ...
       v0.3 - Changed priority numbering system. 1 is now the highest priority, while 5 is lowest.
	    ...
	    - Target selector will now ignore targets which are not targetable, i.e. Fizz's jump, Vladmimir's pool, Zhonya's Hourglass, GA pop.
]]--
