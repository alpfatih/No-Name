...
type 1 refers to preset distance skillshots
example, Sivir Q is type 1 because no matter where you click, the skillshot travels a set distance

type 2 refers to mouse distance skillshots
example Olaf Q is type 2, because it only travels to your mouse, and not its maximum distance

type 3 refers to point AOE --example, Chogath Rupture.if you click outside the maximum range, you will be forced to walk into range before using spell.

type 4 refer to global Line skillshots. its actually just Type 1, but has infinite range

type 5 refers to forced point AOE
example Shaco Deceive. Shaco will still deceive if click outside maximum range, rather than walking into range of your click. another example is Kassadin R(RiftWalk)

type 6 refers to faced ennemy 
example Cassiopeia ulti, etc
