...
miniMap = {}
miniMap.shift = { x = 0, y = 0 }
miniMap.step = { x = 0, y = 0 }
miniMap.offsets = {x1 = 300, y1 = 200, x2 = 300, y2 = 225 }
miniMap.configFile = LIB_PATH.."minimap.cfg"
miniMap.configScript = LIB_PATH.."minimap_wizard.lua"
miniMap.state = 0
